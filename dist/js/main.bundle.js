...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../.0.27.3@css-loader/index.js??ref--1-1!../.1.3.3@postcss-loader/index.js!./normalize.css", function() {
			var newContent = require("!!../.0.27.3@css-loader/index.js??ref--1-1!../.1.3.3@postcss-loader/index.js!./normalize.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/.0.27.3@css-loader/index.js??ref--1-1!../../node_modules/.1.3.3@postcss-loader/index.js!./base.css", function() {
			var newContent = require("!!../../node_modules/.0.27.3@css-loader/index.js??ref--1-1!../../node_modules/.1.3.3@postcss-loader/index.js!./base.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/.0.27.3@css-loader/index.js??ref--1-1!../../node_modules/.1.3.3@postcss-loader/index.js!./body-nav.css", function() {
			var newContent = require("!!../../node_modules/.0.27.3@css-loader/index.js??ref--1-1!../../node_modules/.1.3.3@postcss-loader/index.js!./body-nav.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/.0.27.3@css-loader/index.js??ref--1-1!../../node_modules/.1.3.3@postcss-loader/index.js!./body-right-div.css", function() {
			var newContent = require("!!../../node_modules/.0.27.3@css-loader/index.js??ref--1-1!../../node_modules/.1.3.3@postcss-loader/index.js!./body-right-div.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/.0.27.3@css-loader/index.js??ref--1-1!../../node_modules/.1.3.3@postcss-loader/index.js!./footer.css", function() {
			var newContent = require("!!../../node_modules/.0.27.3@css-loader/index.js??ref--1-1!../../node_modules/.1.3.3@postcss-loader/index.js!./footer.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/.0.27.3@css-loader/index.js??ref--1-1!../../node_modules/.1.3.3@postcss-loader/index.js!./head-adv.css", function() {
			var newContent = require("!!../../node_modules/.0.27.3@css-loader/index.js??ref--1-1!../../node_modules/.1.3.3@postcss-loader/index.js!./head-adv.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/.0.27.3@css-loader/index.js??ref--1-1!../../node_modules/.1.3.3@postcss-loader/index.js!./header-info.css", function() {
			var newContent = require("!!../../node_modules/.0.27.3@css-loader/index.js??ref--1-1!../../node_modules/.1.3.3@postcss-loader/index.js!./header-info.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
					...
					"nemuData": [
						{
							...
							"optionModel": "",
							"mealInfo": ",白萝卜含有大量的维生素和膳食纤维,所含的木质素具有抗癌的功效."
						}
					]
				},
				{
...
// module
exports.push([module.i, "/**\r\n * @file 脚部选项css\r\n * @author Qc<896853205@qq.com>\r\n */\r\n/* ---底部结算-开始--- */\r\n.foot-calculate {\r\n    background: rgb(233,84,70);\r\n    color: #fff;\r\n    padding:10px;\r\n    font-size: 18px;\r\n}\r\n.foot-calculate .foot-claculate-num {\r\n    border: 2px solid #fff;\r\n    border-radius: 50%;\r\n    display: inline-block;\r\n    width: 25px;\r\n    height: 25px;\r\n    line-height: 25px;\r\n    text-align: center;\r\n    margin-right: 10px;\r\n    font-size: 14px;\r\n}\r\n.foot-calculate .over-button {\r\n    display: block;\r\n    border: 0;\r\n    float: right;\r\n    background: #fff;\r\n    color: rgb(233,84,70);\r\n    border-radius:15px;\r\n    padding:5px 8px;\r\n    font-family: \"Montserrat\", \"\\5FAE\\8F6F\\96C5\\9ED1\";\r\n}\r\n/* ---底部结算-结束--- */\r\n/* ---脚步导航-开始--- */\r\nfooter {\r\n    background: rgb(248,249,248);\r\n    position: absolute;\r\n    bottom: 0;\r\n    width: 100%;\r\n}\r\nfooter nav ul li {\r\n    width: 33%;\r\n    float: left;\r\n    list-style-type: none;\r\n    text-align: center;\r\n    font-size:16px;\r\n    color: rgb(186,186,186);\r\n    padding-bottom:5px;\r\n}\r\nfooter nav ul li .fa {\r\n    line-height: 40px;\r\n    font-size: 23px;\r\n}\r\nfooter nav ul li p {\r\n    color: rgb(178,178,178);\r\n}\r\nfooter nav ul li:nth-child(1) {\r\n    width: 34%;\r\n}\r\n.foot-active p,.foot-active .fa{\r\n    color: rgb(232,66,50);\r\n}\r\n/* ---脚步导航-结束--- */", ""]);
...
(function () {
	function App() {
      ...
      */
				...
				watch: {
					nowPrice: function nowPrice(newValue, oldValue) {
						var vm = this;
